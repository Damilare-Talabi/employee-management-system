...
export declare class TenantsComponent implements OnInit {
    ...
    constructor(list: ListService<GetTenantsInput>, injector: Injector, confirmationService: ConfirmationService, service: TenantService, fb: FormBuilder);
    ngOnInit(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TenantsComponent, "abp-tenants", never, {}, {}, never, never>;
}
