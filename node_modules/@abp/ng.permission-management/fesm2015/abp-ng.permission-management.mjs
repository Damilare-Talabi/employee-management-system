...
class PermissionManagementComponent {
    ...
    get selectedGroupPermissions() {
        ...
        return permissions.map(permission => (Object.assign(Object.assign({}, permission), { style: { [margin]: findMargin(permissions, permission) }, isGranted: this.permissions.find(per => per.name === permission.name).isGranted })));
    }
    getChecked(name) {
...
function getPermissions(groups) {
    return groups.reduce((acc, val) => [...acc, ...val.permissions.map(p => (Object.assign(Object.assign({}, p), { groupName: val.name })))], []);
}
