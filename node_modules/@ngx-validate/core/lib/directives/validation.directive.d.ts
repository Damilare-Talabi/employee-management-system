import { AfterViewInit, ChangeDetectorRef, ComponentFactoryResolver, Injector, OnDestroy, Renderer2, ViewContainerRef } from '@angular/core';
...
export declare class ValidationDirective extends AbstractValidationDirective implements AfterViewInit, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ValidationDirective, [null, null, null, { self: true; }, null, null, { skipSelf: true; }, { optional: true; skipSelf: true; }, { optional: true; skipSelf: true; }, { optional: true; }]>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<ValidationDirective, "[formControl],[formControlName]", ["validationDirective"], {}, {}, never>;
}
