...
declare type PermissionWithGroupName = PermissionGrantInfoDto & {
    groupName: string;
};
export declare class PermissionManagementComponent implements PermissionManagement.PermissionManagementComponentInputs, PermissionManagement.PermissionManagementComponentOutputs {
    ...
    constructor(service: PermissionsService, configState: ConfigStateService);
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PermissionManagementComponent, "abp-permission-management", ["abpPermissionManagement"], { "providerName": "providerName"; "providerKey": "providerKey"; "hideBadges": "hideBadges"; "visible": "visible"; }, { "visibleChange": "visibleChange"; }, never, never>;
}
export {};
